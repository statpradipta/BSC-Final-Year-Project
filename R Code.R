...
ggplot(data, aes(x = Exercise, y = Weight_loss)) +
  ...
  geom_smooth(method = "lm", color = "#D55E00", size = 1) +
  geom_abline(method = "lm", color = "#D55E00", size = 1) +
  ...
  geom_abline(intercept = -7.54, slope = 1.86, color = "black", linetype = "solid", size = 1) +
